...
void main() {
  group('$Feature', () {
    ...
    test('== compares cubics by value', () {
      ...
      expect(
        CornerFeature([cubic]).hashCode,
        CornerFeature([equalCubic]).hashCode,
      );
    ...
    test('== compares reversed and transformed features by value', () {
      ...
      expect(
        CornerFeature([cubic]).reversed,
        CornerFeature([reversedCubic], convex: false),
      );
      expect(
    ...
    test('toString names the feature type', () {
      ...
      expect(
        ...
        'EdgeFeature(cubics: [$cubicString])',
      );
      expect(
