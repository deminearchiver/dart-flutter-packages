...
void main() {
  ...
  test('$CornerRounding equality', () {
    ...
    expect(
      const CornerRounding(radius: 5),
      isNot(const CornerRounding(radius: 6)),
    );
    expect(
      const CornerRounding(smoothing: 0.5),
      isNot(const CornerRounding(smoothing: 0.6)),
    );
    expect(
      const CornerRounding(radius: 1),
      isNot(const CornerRounding(smoothing: 1)),
    );
