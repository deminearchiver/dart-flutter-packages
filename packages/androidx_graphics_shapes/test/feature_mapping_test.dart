  ...
  group('FeatureMapping', () {
    ...
    void verifyMapping(
      ...
      for (final (progress1, progress2) in map) {
        final ProgressableFeature feature1 = f1.firstWhere(
          (f) => f.progress == progress1,
        );
        final ProgressableFeature feature2 = f2.firstWhere(
          (f) => f.progress == progress2,
        );
