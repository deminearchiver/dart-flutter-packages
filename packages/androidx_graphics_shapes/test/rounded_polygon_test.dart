...
void main() {
  group('$RoundedPolygon', () {
    ...
    test('default constructor', () {
      ...
      final squarePVRounded = RoundedPolygon(
        4,
    ...
    test('fromVertices', () {
      ...
      expect(
        () => RoundedPolygon.fromVertices(const [p0, p1]),
        throwsArgumentError,
      );
    ...
    test('star and pillStar require at least 3 vertices per radius', () {
      expect(
        () => RoundedPolygon.star(numVerticesPerRadius: 2),
        throwsArgumentError,
      );
      expect(
        () => RoundedPolygon.pillStar(numVerticesPerRadius: 2),
        throwsArgumentError,
      );
    });
    ...
    group('fromFeatures', () {
      ...
      test('throws for non continuous features', () {
        ...
        final cubic2 = CubicBezier.straightLine(
          const Point(10, 10),
          const Point(20, 20),
        );
        expect(
    ...
    test('uneven smoothing 2', () {
      ...
      for (var i = 0; i <= points; i++) {
        ...
        final double factor = math.min(
          0.4 / (smoothWantedV0 + smoothWantedV3),
          1.0,
        );
        doUnevenSmoothTest(
          rounding0: CornerRounding(radius: 0.4, smoothing: smooth),
