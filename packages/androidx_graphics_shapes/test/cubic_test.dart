...
void main() {
  group('$CubicBezier', () {
    ...
    test('transform', () {
      ...
      expectPointsEqualish(
        ...
        transformedCubic.anchor0,
      );
      expectPointsEqualish(
        cubic.control0 + translationVector,
        transformedCubic.control0,
      );
      expectPointsEqualish(
        cubic.control1 + translationVector,
        transformedCubic.control1,
      );
      expectPointsEqualish(
        cubic.anchor1 + translationVector,
        transformedCubic.anchor1,
      );
    });
  ...
  group('pathFromCubics', () {
    ...
    test('startAngle rotates around rotationPivot', () {
      ...
      final Path path = pathFromCubics(
        diamond,
    ...
    test('repeatPath doubles the contour', () {
      final double single = pathFromCubics(triangle)
          .computeMetrics()
          .first
          .length;
