...
@internal
class DoubleMapper(List<(double, double)> mappings) {
  this {
  ...
  final _sourceValues = List<double>.filled(mappings.length, 0.0);

  final _targetValues = List<double>.filled(mappings.length, 0.0);
