...
class _IndeterminateLoadingIndicatorPainter
    extends _StatefulCustomPainter<_IndeterminateLoadingIndicatorPainter> {
...
abstract class _StatefulCustomPainter<T extends _StatefulCustomPainter<T>>
    with ChangeNotifier
    implements CustomPainter {
  _StatefulCustomPainter() {
