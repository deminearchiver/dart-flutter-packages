...
int LZ4F_getBlockSize(LZ4F_blockSizeID_t blockSizeID) {
  return _LZ4F_getBlockSize(blockSizeID.value);
}
...
LZ4F_errorCodes LZ4F_getErrorCode(int functionResult) {
  return LZ4F_errorCodes.fromValue(_LZ4F_getErrorCode(functionResult));
}
...
@Deprecated('use LZ4_compress_HC() instead')
@ffi.Native<
  ffi.Int Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>, ffi.Int)
>()
...
@Deprecated('use LZ4_compress_HC_extStateHC() instead')
@ffi.Native<
  ffi.Int Function(
    ffi.Pointer<ffi.Void>,
    ffi.Pointer<ffi.Char>,
...
XXH_errorcode XXH32_freeState(ffi.Pointer<XXH32_state_t> statePtr) {
  return XXH_errorcode.fromValue(_XXH32_freeState(statePtr));
}
...
XXH_errorcode XXH32_reset(ffi.Pointer<XXH32_state_t> statePtr, int seed) {
  return XXH_errorcode.fromValue(_XXH32_reset(statePtr, seed));
}
...
XXH_errorcode XXH32_update(
  ...
  return XXH_errorcode.fromValue(_XXH32_update(statePtr, input, length));
}
...
XXH_errorcode XXH64_freeState(ffi.Pointer<XXH64_state_t> statePtr) {
  return XXH_errorcode.fromValue(_XXH64_freeState(statePtr));
}
...
XXH_errorcode XXH64_reset(ffi.Pointer<XXH64_state_t> statePtr, int seed) {
  return XXH_errorcode.fromValue(_XXH64_reset(statePtr, seed));
}
...
XXH_errorcode XXH64_update(
  ...
  return XXH_errorcode.fromValue(_XXH64_update(statePtr, input, length));
}
...
typedef LZ4F_AllocFunctionFunction = ffi.Pointer<ffi.Void> Function(
  ffi.Pointer<ffi.Void> opaqueState,
  ffi.Size size,
);
typedef DartLZ4F_AllocFunctionFunction = ffi.Pointer<ffi.Void> Function(
  ffi.Pointer<ffi.Void> opaqueState,
  int size,
);
...
typedef LZ4F_CallocFunctionFunction = ffi.Pointer<ffi.Void> Function(
  ffi.Pointer<ffi.Void> opaqueState,
  ffi.Size size,
);
typedef DartLZ4F_CallocFunctionFunction = ffi.Pointer<ffi.Void> Function(
  ffi.Pointer<ffi.Void> opaqueState,
  int size,
);
...
final class LZ4F_CustomMem extends ffi.Struct {
  ...
  static ffi.Pointer<LZ4F_CustomMem> $allocate(
    ffi.Allocator $allocator, {
    required LZ4F_AllocFunction customAlloc,
    required LZ4F_CallocFunction customCalloc,
    required LZ4F_FreeFunction customFree,
    required ffi.Pointer<ffi.Void> opaqueState,
  }) => $allocator<LZ4F_CustomMem>()
    ..ref.customAlloc = customAlloc
    ..ref.customCalloc = customCalloc
    ..ref.customFree = customFree
    ..ref.opaqueState = opaqueState;
}
...
typedef LZ4F_FreeFunctionFunction = ffi.Void Function(
  ffi.Pointer<ffi.Void> opaqueState,
  ffi.Pointer<ffi.Void> address,
);
typedef DartLZ4F_FreeFunctionFunction = void Function(
  ffi.Pointer<ffi.Void> opaqueState,
  ffi.Pointer<ffi.Void> address,
);
...
final class LZ4F_cctx_s extends ffi.Struct {
  ...
  set blockCompressMode(LZ4F_BlockCompressMode_e value) =>
      blockCompressModeAsInt = value.value;
}
...
final class LZ4F_dctx_s extends ffi.Struct {
  ...
  set dStage(dStage_t value) => dStageAsInt = value.value;
...
final class LZ4F_decompressOptions_t extends ffi.Struct {
  ...
  static ffi.Pointer<LZ4F_decompressOptions_t> $allocate(
    ffi.Allocator $allocator, {
    required int stableDst,
    required int skipChecksums,
    required int reserved1,
    required int reserved0,
  }) => $allocator<LZ4F_decompressOptions_t>()
    ..ref.stableDst = stableDst
    ..ref.skipChecksums = skipChecksums
...
final class LZ4F_frameInfo_t extends ffi.Struct {
  ...
  set blockSizeID(LZ4F_blockSizeID_t value) => blockSizeIDAsInt = value.value;
  ...
  set blockMode(LZ4F_blockMode_t value) => blockModeAsInt = value.value;
  ...
  set contentChecksumFlag(LZ4F_contentChecksum_t value) =>
      contentChecksumFlagAsInt = value.value;
  ...
  set frameType(LZ4F_frameType_t value) => frameTypeAsInt = value.value;
  ...
  set blockChecksumFlag(LZ4F_blockChecksum_t value) =>
      blockChecksumFlagAsInt = value.value;

  static ffi.Pointer<LZ4F_frameInfo_t> $allocate(
    ffi.Allocator $allocator, {
    required LZ4F_blockSizeID_t blockSizeID,
    required LZ4F_blockMode_t blockMode,
    required LZ4F_contentChecksum_t contentChecksumFlag,
    required LZ4F_frameType_t frameType,
    required int contentSize,
    required int dictID,
    required LZ4F_blockChecksum_t blockChecksumFlag,
  }) => $allocator<LZ4F_frameInfo_t>()
    ..ref.blockSizeID = blockSizeID
    ..ref.blockMode = blockMode
    ..ref.contentChecksumFlag = contentChecksumFlag
    ..ref.frameType = frameType
    ..ref.contentSize = contentSize
    ..ref.dictID = dictID
    ..ref.blockChecksumFlag = blockChecksumFlag;
}
...
final class LZ4_streamDecode_t_internal extends ffi.Struct {
  ...
  static ffi.Pointer<LZ4_streamDecode_t_internal> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<LZ4_byte> externalDict,
    required ffi.Pointer<LZ4_byte> prefixEnd,
    required int extDictSize,
    required int prefixSize,
  }) => $allocator<LZ4_streamDecode_t_internal>()
    ..ref.externalDict = externalDict
    ..ref.prefixEnd = prefixEnd
    ..ref.extDictSize = extDictSize
    ..ref.prefixSize = prefixSize;
}
