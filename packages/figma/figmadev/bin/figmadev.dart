...
Future<int> main(List<String> args) async {
  final commandRunner = BetterCommandRunner<StandardGlobalOption<bool>, void>(
    "example",
    "Example CLI command",
    globalOptions: [StandardGlobalOption.quiet, StandardGlobalOption.verbose],
  )..addCommand(TimeSeriesCommand());
  ...
  final logger = StdOutLogger(logLevel)
    ...
    ..debug("A debug message that will not be shown unless --verbose is set");
