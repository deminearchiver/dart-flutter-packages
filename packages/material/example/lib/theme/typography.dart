...
const _firaCode = "Fira Code";
const _googleSans = "Google Sans";
const _googleSansCode = "Google Sans Code";
...
class TypographyDefaults with Diagnosticable {
  ...
  static const material2025 = TypographyDefaults.from(
    typeface: .from(
  ...
  static const material2026 = TypographyDefaults.from(
    typeface: .from(
...
abstract final class DefaultTextStyles {
